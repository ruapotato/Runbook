...
static const Package PKG_HOME = {
    "vane-home", "1.0", "somebody's home directory",
    {
      { "/root/Desktop/read-me-first.txt",
        "If you are reading this, the last run ended badly.\n"
        "\n"
        "The computer keeps its disk. The hull does not keep anything. That is the\n"
        "only piece of good news on this ship and it is a bigger one than it sounds:\n"
        "everything you write down survives you.\n"
        "\n"
        "WHAT IS ON HERE\n"
        "\n"
        "  /root/examples   scripts that already work. gunner.py is four lines and\n"
        "                   it fires your gun for the rest of the fight.\n"
        "  /root/scripts    yours. Empty the first time.\n"
        "  /home/vane       Vane keeps notes. They are still on the crew. Read them.\n"
        "\n"
        "  `rb help` lists every command the ship takes. Every one of them is also a\n"
        "  button on the bridge, and every button prints the command it sent.\n"
        "\n"
        "WHAT I WOULD DO DIFFERENTLY\n"
        "\n"
        "  Put a bar in the computer before the fight starts, not after it is going\n"
        "  badly. A script with no power does nothing at all, and finding that out\n"
        "  while the engine room is on fire is not the moment.\n"
        "\n"
        "  There is a record button on the panel. It watches what you do and writes\n"
        "  it down as a script you can edit. I found it far too late.\n"
        "\n", 0644, NULL },
      { "/home/vane/notes.txt",
        "Things I keep having to work out again.\n"
        "\n"
        "THE REACTOR IS THE WHOLE GAME\n"
        "  Eight bars. Shields, engines, weapons, oxygen, medbay, computer -- and\n"
        "  they all want them. Nothing else in this ship is a real decision. That\n"
        "  is one.\n"
        "\n"
        "  Shields eat shots. Weapons take them off the raider. Oxygen keeps the\n"
        "  air. The computer runs scripts. You cannot have all four and the fight\n"
        "  is about which one you are wrong about.\n"
        "\n"
        "WHAT PEOPLE DO IS WHERE THEY STAND\n"
        "  There is no order to give. Put somebody in a burning room and they fight\n"
        "  the fire. Put them in a broken one and they repair it. Put them in a\n"
        "  working one and they man it, which makes it better than it is.\n"
        "\n"
        "  So `send Vane 2` is the only crew command there is, and the whole skill\n"
        "  is knowing which room.\n"
        "\n"
        "AND THEY WALK\n"
        "  Which is the part I keep getting wrong. Two rooms is about three and a\n"
        "  half seconds and they fight nothing on the way. A shut door on the route\n"
        "  costs longer again.\n"
        "\n"
        "  So it is not `who is free`, it is `who is NEAREST`, and those are\n"
        "  different people about half the time. `rb crew` says where everybody is.\n"
        "\n"
        "THE PAD\n"
        "  `send Vane 3 now` puts somebody there instantly. It needs power in the\n"
        "  teleporter and it needs OUR shields down, because you cannot put a\n"
        "  person through a shield you are hiding behind.\n"
        "\n"
        "  Which sounds useless and is not: the moment their volley strips the\n"
        ...
        "\n"
        "  Their shields are in the way. Their weapons are what is killing you.\n"
        "  Their engines are why one shot in ten goes wide. Break the guns and you\n"
        "  buy thirty seconds -- they patch it, so spend the thirty seconds.\n"
        "\n"
        "FIRE\n"
        "  It spreads. It spreads through open doors, and a shut door stops it dead.\n"
        "  `door 4 shut` costs nothing and I forget every time.\n"
        "\n"
        "  A fire also eats the air, so a room that has burned is a room you cannot\n"
        "  stand in afterwards. Shut it, let it go out, open it again.\n"
        "\n"
        "VACUUM\n"
        "  A breach drains the room and then the ones next to it. Shut the door and\n"
        "  it drains one room instead of six. Anybody standing in it starts dying\n"
        "  quietly, and quietly is the problem -- nothing flashes.\n"
        "\n"
        "THE COMPUTER\n"
        "  Bars in the computer buy you scheduling time and nothing else. One bar\n"
        "  runs a loop that watches one thing. Three runs several. Zero runs\n"
        "  nothing, and your script sits there doing nothing while you wonder what\n"
        "  you got wrong.\n"
        "\n"
        "  It is a trade, not a cheat. I have lost fights to a script I was paying\n"
        "  for and not using.\n"
        "\n", 0644, NULL },
      { "/home/vane/TODO",
        "- finish the firewatch script. bin/README says why I stopped, it is a bad\n"
        "  reason, ignore it and finish it\n"
        "\n"
        "- work out whether it is ever right to put a bar in the medbay. I have\n"
        "  never once done it and I have also never once checked\n"
        "\n"
        "- a script that shuts the door on a room that is on fire, without being\n"
        "  told which room. `rb rooms` says which. It is a for loop and an if\n"
        "\n"
        "- stop firing at their hull while their shields are up. I know. I know\n"
        "\n"
        "- ask the captain what the plan is if we win\n"
        "\n", 0644, NULL },
      { "/home/vane/Documents/diary.txt",
        "The day I wrote the loop.\n"
        "\n"
        "Third fight this month. Same as the others: the gun charges, I click it,\n"
        "the gun charges, I click it. Ninety seconds of that while the engine room\n"
        "burns and I am not looking at the engine room because I am watching a bar\n"
        "fill up.\n"
        "\n"
        "So I wrote four lines. It watches the gun and fires it. That is all it\n"
        "does. It is not clever and I am not a programmer.\n"
        "\n"
        "And then I spent the whole fight looking at my ship.\n"
        "\n"
        "I have been on this crew eleven months and that was the first time I saw\n"
        "the fire start rather than noticing it had. We won that one. We should\n"
        "have won the last three.\n"
        "\n"
        "----\n"
        "\n"
        "Later. The thing nobody tells you is that the loop is not the point. The\n"
        "point is what you do with the attention it gives back. I did not get\n"
        "faster at clicking. I got to stop clicking, and that is a different\n"
        "person flying the ship.\n"
        "\n"
        "----\n"
        "\n"
        "Later still. Wrote a second one that watches for fire and sends whoever\n"
        "is nearest. It is wrong about who is nearest. I do not care yet.\n"
        "\n"
        "The captain asked how long it took. Twenty minutes. He asked why I had\n"
        "not done it in month one and I did not have an answer, and I have been\n"
        "thinking about it since. I think the honest answer is that nobody told me\n"
        "I was allowed to.\n"
        "\n", 0644, NULL },
      { "/home/vane/bin/README",
        "firewatch-half.py -- why I stopped.\n"
        "\n"
        "It works. That is the awkward part. It watches the rooms, finds the one\n"
        "that is worst on fire, and sends somebody.\n"
        "\n"
        "What it does not do is know who is CLOSEST, and the first time I ran it\n"
        "properly it walked Corrigan out of the engine room, across the ship, past\n"
        "a fire, to a different fire. He got there. It was slower than doing it\n"
        "myself and I decided the whole idea was wrong and stopped.\n"
        "\n"
        "That was the wrong lesson. The idea was fine. The script was three lines\n"
        "short of fine, and the three lines are: read `rb crew`, look at which room\n"
        "each of them is in, and pick the one whose room number is nearest.\n"
        "\n"
        "It is honestly an afternoon. I never had an afternoon.\n"
        "\n"
        "If you finish it, put it in /root/scripts so it survives whatever happens\n"
        "to us.\n"
        "\n", 0644, NULL },
      { "/home/vane/bin/firewatch-half.py",
        "# firewatch-half.py -- send somebody to the worst fire.\n"
        "#\n"
        "# WHAT IS WRONG WITH IT is in README, next to this file. The short version:\n"
        "# it always sends the same person, and that person is sometimes on the\n"
        "# other side of the ship.\n"
        "#\n"
        "#   run /home/vane/bin/firewatch-half.py\n"
        "\n"
        "while True:\n"
        "    s = json(ship())\n"
        "    if s[\"over\"] == \"true\":\n"
        "        exit(0)\n"
        "\n"
        "    # Find the room that is worst on fire.\n"
        "    worst = -1\n"
        "    worst_fire = 0\n"
        "    n = 0\n"
        "    for line in lines(do(\"rooms\")):\n"
        "        r = json(line)\n"
        "        if int(r[\"fire\"]) > worst_fire:\n"
        "            worst_fire = int(r[\"fire\"])\n"
        "            worst = n\n"
        "        n = n + 1\n"
        "\n"
        "    # HERE IS THE BUG. It is always Vane. It should be whoever is nearest,\n"
        "    # and `crew` will tell you where everybody is.\n"
        "    if worst >= 0:\n"
        "        do(\"send Vane \" + str(worst))\n"
        "\n", 0755, NULL },
      { "/home/vane/.sh_history",
        "rb rooms\n"
        "rb crew\n"
        "rb power shields 3\n"
        "rb power weapons 2\n"
        ...
        "rb status\n"
        "rb enemy\n"
        "py bin/firewatch-half.py\n"
        "rb power computer 1\n"
        "cat /root/examples/gunner.py\n"
        "rb run /root/examples/gunner.py\n"
        "rb status\n"
        "\n", 0644, NULL },
      { "/home/vane/Documents/handover.txt",
        "If somebody else ends up at this station.\n"
        "\n"
        "THE FIGHT\n"
        "  One raider. They shoot in volleys, which is why the shields feel fine\n"
        "  and then suddenly do not -- two get through together and the second one\n"
        "  starts a fire.\n"
        "\n"
        "  Space stops time. Use it. Nothing you decide while paused costs\n"
        "  anything, and thinking is the only free thing on this ship.\n"
        "\n"
        "THE ORDER THINGS HAPPEN IN\n"
        "  Shields first, always. Then the gun. Then whatever the fight is\n"
        "  actually doing to you -- and it is usually air.\n"
        "\n"
        "  Do not repair the medbay. Nobody is going to the medbay.\n"
        "\n"
        "THE CONSOLE\n"
        "  Everything you click prints as a command. That is not decoration. It is\n"
        "  the same line you can type, and the same line a script can send, and the\n"
        "  reason you already know how to write one by the time you want to.\n"
        "\n"
        "  `rb help` is the whole vocabulary. It is one screen.\n"
        "\n"
        "Good luck. It is a good ship when you are ahead of it.\n"
        "\n"
        "-- Vane\n"
        "\n", 0644, NULL },
      { "/home/vane/.profile",
        "# vane's shell profile.\n"
        "#\n"
        "# Not much here. The shell on this machine is small and I stopped fighting\n"
        "# it.\n"
        "\n"
        "# The two I typed the most. `rb` is the ship, and every button on the\n"
        "# bridge goes through it -- which took me months to notice, so: it is\n"
        "# written down here where you will trip over it.\n"
        "#\n"
        "#   rb rooms\n"
        "#   rb status\n"
        "#\n"
...
void image_generated(const Machine *m, const char *path, Buf *out)
{
    if (strcmp(path, "/usr/lib/sysinit/init") == 0)
        ...
        "check(\"do-answers-plainly\", find(do(\"power shields 2\"), \"shields at 2\"), 0)\n"
        "check(\"do-drops-the-envelope\", find(do(\"power shields 2\"), \"+OK\"), -1)\n"
        "check(\"do-refuses\", find(do(\"power shields 99\"), \"-ERR\"), 0)\n"
        "check(\"do-gives-the-body\", find(lines(do(\"rooms\"))[0], \"reactor\") > 0, True)\n"
        "\n"
        "parts = split(\"a,b,c\", \",\")\n"
...
void machine_install(Machine *m, uint64_t seed)
{
    ...
    static const char *DIRS[] = {
        ...
        "/home/vane", "/home/vane/Documents", "/home/vane/bin",
        NULL
    };
